...
<div class="wrap">
    ...
    <div class="content">
        ...
        <div class="content-head">
            <img src="{{$settings->site_url}}/images/mail/confirmation-head.jpg" alt="Confirmation" width="1144" height="564">
        </div>
    ...
    <div class="foot">
        ...
        <p class="m-0">You are signed up for this email as {{$user->email}}.</p>
