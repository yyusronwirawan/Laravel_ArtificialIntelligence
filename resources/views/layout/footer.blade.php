	...
	<div class="relative">
		...
		<div class="container">
			...
			<div class="flex flex-wrap items-center justify-center gap-4 py-9 max-sm:text-center">
				<p class="text-[14px] opacity-60 !text-end">{{__($fSetting->footer_copyright)}}</p>
			</div>
		</div>
	</div>
</footer>
