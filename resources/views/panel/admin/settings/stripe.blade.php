        ...
        <div class="container-xl">
			<div class="row">
				<div class="col-md-5 mx-auto">
					<form id="settings_form" onsubmit="return stripeSettingsSave();" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="stripe_key" name="stripe_key" value="*************">
								</div>
							</div>
                            ...
                            @else
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label">{{__('Stripe Api Key (Stripe Key)')}}</label>
                                        <input type="text" class="form-control" id="stripe_key" name="stripe_key" value="{{$setting->stripe_key}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label">{{__('Stripe Secret Key (Stripe Secret)')}}</label>
                                        <input type="text" class="form-control" id="stripe_secret" name="stripe_secret" value="{{$setting->stripe_secret}}">
                                    </div>
                                </div>
                            @endif
							...
							<div class="col-md-12">
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="stripe_base_url" name="stripe_base_url" value="{{$setting->stripe_base_url}}">
								</div>
							</div>
						</div>
