...
@section('content')
        ...
        <div class="container-xl">
            <div class="items-center row g-2">
                <div class="col">
					...
					<p class="mb-2">{{__('Manage AI Writer Categories')}}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="pt-6 page-body">
        <div class="container-xl">
            <div class="mb-2">
                <a href="{{ LaravelLocalization::localizeUrl( route('dashboard.admin.openai.categories.addOrUpdate') ) }}" class="btn btn-success">{{__('Add Category')}}</a>
            </div>
            <div class="card">
						...
						@foreach($list as $entry)
							<tr>
								...
								<td class="whitespace-nowrap">
									<a href="{{ LaravelLocalization::localizeUrl( route('dashboard.admin.openai.categories.addOrUpdate', $entry->id) ) }}" class="btn w-[36px] h-[36px] p-0 border hover:bg-[var(--tblr-primary)] hover:text-white" title="{{__('Edit')}}">
									...
									<a href="{{ LaravelLocalization::localizeUrl( route('dashboard.admin.openai.categories.delete', $entry->id) ) }}" onclick="return confirm('{{__('Are you sure? This is permanent.')}}')" class="btn p-0 border w-[36px] h-[36px] hover:bg-red-600 hover:text-white" title="{{__('Delete')}}">
