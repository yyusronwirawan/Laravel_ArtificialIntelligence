        ...
        <div class="container-xl">
            <div class="row">
                <div class="col-md-5 mx-auto">
                    <form id="item_form" onsubmit="return toolsCreateOrUpdate({{$item!=null ? $item->id : null}});" enctype="multipart/form-data">
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="image" name="image" accept="image/*" {{$item!=null ? null : 'required'}}>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
