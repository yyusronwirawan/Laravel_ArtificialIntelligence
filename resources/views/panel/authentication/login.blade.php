					...
					<div class="mx-auto col-lg-6">
						...
						<div class="flex flex-wrap !gap-4 text-[13px] -tracking-[0.15px]]">
							...
							<a href="{{route('login.facebook')}}" class="flex items-center w-[calc(50%-0.5rem)] grow !py-3 !px-4 border border-[--tblr-border-color] rounded-[10px] !no-underline text-heading transition-all hover:shadow-lg hover:-translate-y-1">
								<svg class="shrink-0 !me-2" width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M24 12C24 5.3726 18.6274 2.65179e-05 12 2.65179e-05C5.37258 2.65179e-05 0 5.3726 0 12C0 17.9896 4.38823 22.954 10.125 23.8542V15.4688H7.07813V12H10.125V9.35628C10.125 6.34878 11.9165 4.68753 14.6576 4.68753C15.9705 4.68753 17.3438 4.9219 17.3438 4.9219V7.87503H15.8306C14.3399 7.87503 13.875 8.80003 13.875 9.74902V12H17.2031L16.6711 15.4688H13.875V23.8542C19.6118 22.954 24 17.9896 24 12Z" fill="#1877F2"/> <path d="M16.6711 15.4687L17.2031 12H13.875V9.74899C13.875 8.80001 14.3399 7.875 15.8306 7.875H17.3438V4.92187C17.3438 4.92187 15.9705 4.6875 14.6576 4.6875C11.9165 4.6875 10.125 6.34875 10.125 9.35625V12H7.07812V15.4687H10.125V23.8542C10.7359 23.9501 11.3621 24 12 24C12.6379 24 13.2641 23.9501 13.875 23.8542V15.4687H16.6711Z" fill="white"/> </svg>
						...
						<form novalidate="novalidate" onsubmit="return LoginForm();">
							<div class="mb-[20px]">
								...
								<input type="email" class="form-control" id="email" placeholder="your@email.com" value="{{env('APP_STATUS') == 'Demo' ? 'admin@admin.com' : ''}}" autocomplete="off">
							</div>
							<div class="mb-[25px]">
								...
								<div class="input-group">
									<input type="password" class="form-control" id="password" placeholder="Your password" value="{{env('APP_STATUS') == 'Demo' ? '12345678' : ''}}" autocomplete="off">
									<span class="bg-transparent border-0 input-group-text">
										<a href="#" class="link-secondary show-password" title="Show password" data-bs-toggle="tooltip">
							...
							<div class="row">
								...
								<div class="col !text-end">
									<a href="{{route('forgot_password')}}">{{__('Forgot Password?')}}</a>
								</div>
							</div>
							<div class="row mt-[25px]">
								<div class="col">
									<button id="LoginFormButton" class="btn btn-primary w-100">{{__('Sign in')}}</button>
								</div>
							</div>
                            <!-- TODO Openai Demo -->
                            @if(env('APP_STATUS') == 'Demo')
                                <hr class="my-10">
                                <h3 class="card-title text-heading">{{__('Test Credentials')}}</h3>
                                <div class="card">
